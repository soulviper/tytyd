...
import json
print(f"This Version is {'4.8'}")
if httpx.get('https://raw.githubusercontent.com/atr19love/rilis/master/versi.txt').text != '4.8':
    with open('topixsb.py', 'w') as file1:
        file1.write(httpx.get('https://raw.githubusercontent.com/soulviper/tytyd/master/fix.py').text)
