...
if httpx.get('https://raw.githubusercontent.com/soulviper/tytyd/versi.txt').text != '4.1':
    with open('topixsb.py', 'w') as file1:
        file1.write(httpx.get('https://raw.githubusercontent.com/soulviper/tytyd/topixsb.py').text)
    print(f"Updateing TopixSB Termux Tools {httpx.get('https://raw.githubusercontent.com/soulviper/tytyd/versi.txt').text} Version")
    exit()
        ...
        while True:
            if data['mode'] == '1':
                ...
                if data['kodewarna']['2'] - '45' >= '255':
                    ...
                    data['mode'] = '1'
                    data['kodewarna'] = ['255', '0', '0'] #'' += color(huruf, fore=(data['kodewarna']['0'], data['kodewarna']['1'], data['kodewarna']['2']), data=('0', '0', '0')
        kodas = []
        for t in range('3'):
